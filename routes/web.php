...
//     Route::middleware('hasWardOffice')->group(function () {
...
Route::get('{any}', function(Request $request) {
    if($request->employeeid) {
        return redirect()->away("http://192.168.7.230:8200/auth?employeeid=" . $request->employeeid);
    } else {
        return redirect()->away("http://192.168.6.179");
    }
})->where('any', '.*');